...
define(["a/Pi", "lib/jquery-ui"], function(aPi, jQueryUI) {
  var Typeahead, _ref;
  return Typeahead = (function(_super) {
    ...
    Typeahead.prototype.attr = function() {
      return Typeahead.__super__.attr.apply(this, arguments).concat(["uri", "msg"]);
    };
    ...
    Typeahead.prototype.bindKeys = function() {
